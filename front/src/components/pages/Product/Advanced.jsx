...
{/* Form Advanced Search */}
         ...
         <form className={styles.product} ref={logInputs} onSubmit={(e) => { search(e); window.scrollTo(0, 700) }} >
...
{/* Display Percent */}
            ...
            <div>
               <label>Au moins <span style={{ color: '#b07f00', fontWeight: '500' }}>{percent}</span> % de cacao</label>
               <div>
                  <p>20 %</p>
