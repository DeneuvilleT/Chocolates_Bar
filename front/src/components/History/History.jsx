...
const History = () => {
   return (
      <main className={styles.history}>
         ...
         <figure>
            <h1>L'histoire du chocolat</h1>
         </figure>

         <section>

            <h2>Origines</h2>
            <p>Le chocolat [ ʃɔ.kɔ.la], terme d'origine mésoaméricaine, est un aliment plus ou moins sucré produit à partir de la fève de cacao. Celle-ci est fermentée, torréfiée, broyée jusqu'à former une pâte de cacao liquide dont est extraite la matière grasse appelée beurre de cacao. Le chocolat est constitué du mélange, dans des proportions variables, de pâte de cacao, de beurre de cacao et de sucre ; auxquels sont ajoutées éventuellement des épices, comme la vanille, ou des matières grasses végétales.
